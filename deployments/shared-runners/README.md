...
|------|-------------|------|---------|:--------:|
| <a name="input_ami_housekeeper_dry_run"></a> [ami\_housekeeper\_dry\_run](#input\_ami\_housekeeper\_dry\_run) | Report release AMIs older than seven days without deleting them | `bool` | `true` | no |
