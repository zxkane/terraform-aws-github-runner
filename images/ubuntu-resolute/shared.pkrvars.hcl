...
custom_shell_commands = [
  ...
  "(chrome_profile=\"$(mktemp -d)\" && trap 'rm -rf \"$chrome_profile\"' EXIT && timeout --signal=TERM --kill-after=5s 90s /usr/local/bin/google-chrome-ci --headless --disable-gpu --user-data-dir=\"$chrome_profile\" --dump-dom about:blank > /dev/null)",
  "gh --version",
