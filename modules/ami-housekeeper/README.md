...
| <a name="input_lambda_ami_policy_json"></a> [lambda\_ami\_policy\_json](#input\_lambda\_ami\_policy\_json) | Optional IAM policy JSON override for AMI discovery and deletion. | `string` | `null` | no |
